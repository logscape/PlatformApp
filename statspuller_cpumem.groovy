...
sql.eachRow("select RESOURCE_NAME,ATTRIBUTE_NAME,TIME_STAMP,ATTRIBUTE_VALUE_NUM, ATTRIBUTE_VALUE_STR from RESOURCE_METRICS WHERE (TIME_STAMP > DateADD(mi, -5, Current_TimeStamp)) AND (ATTRIBUTE_NAME IN ('nthreads','processes','cu_t','slot','ncores','mem','maxswp','processpri','memUtil','tmp','swpUtil','nprocs','maxmem','swp'));"){ row -> 
