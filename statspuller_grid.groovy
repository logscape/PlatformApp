...
sql.eachRow("select RESOURCE_NAME,ATTRIBUTE_NAME,TIME_STAMP,ATTRIBUTE_VALUE_NUM, ATTRIBUTE_VALUE_STR from RESOURCE_METRICS WHERE (TIME_STAMP > DateADD(mi, -5, Current_TimeStamp)) AND (ATTRIBUTE_NAME IN ('freeslot','acu','r15m','release_mode'));"){ row -> 
